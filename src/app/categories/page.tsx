...
export default function CategoriesPage() {
  ...
  return (
    <main className="px-5 lg:px-10 py-8 max-w-2xl">
      <h1 className="text-3xl font-black tracking-tight mb-8">{tr.nav.categories}</h1>

      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        <div>
          <p className="text-xs uppercase tracking-wide text-mute font-bold mb-3">{tr.home.sales}</p>
        ...
        <div>
          <p className="text-xs uppercase tracking-wide text-mute font-bold mb-3">{tr.home.expense}</p>
          <div className="bg-surface border border-border rounded-2xl overflow-hidden">
